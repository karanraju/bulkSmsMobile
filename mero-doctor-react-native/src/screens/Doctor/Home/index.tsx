...
export const HomeScreen: React.FC<HomeScreenProps> = ({setUrl}) => {
  ...
  return (
    <View style={stylesHome.mainContainer}>
      <Greeting name='Dr. Upendra Devkota' style={{padding:12}}/>
        ...
        <View style={stylesHome.scheduleHeader}>
          <TouchableOpacity
            ...
            <View style={stylesHome.scheduleHeaderContent}>
              <Calender />
              <Text style={stylesHome.scheduleHeaderText}>My Schedule(5)</Text>
              <View>
                {showContainer ? (
                  <DownArrow />
                ) : (
          ...
          <ScrollView>
              ...
              <View style={stylesHome.timelineContainer}>
                <View
                  ref={boxRef}
                  style={[
                    stylesHome.currentTimeIndicator,
                    {marginTop: marginData},
                  ]}>
                  <View style={stylesHome.timeRow}>
                    <View ref={timeRef} style={stylesHome.timeBox}>
                ...
                <View style={stylesHome.timelineLeft}>
                  <CustomTimeLine timeTextStyle={{color:color.white.white100}} borderColor={color.white.white100}/>
                </View>
                <ImageBackground
